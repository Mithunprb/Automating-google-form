...
for data in datas:
    ...
    check1 = func = random.choice([check1_0, check1_1, check1_2])
    check1.click()
    ...
    check2 = func = random.choice([check2_0, check2_1, check2_2, check2_3])
    check2.click()
    ...
    check4 = func = random.choice([check4_0, check4_1, check4_2])
    check4.click()
    ...
    check5 = func = random.choice([check5_0, check5_1])
    check5.click()  
    ...
    check6_1 = driver.find_element_by_xpath(
        '//*[@id="mG61Hd"]/div[2]/div/div[2]/div[8]/div/div/div[2]/div[1]/div/span/div/div[2]/label')
    check6 = func = random.choice([check6_0, check6_1])
    check6.click()
    ...
    check7 = func = random.choice([check7_0, check7_1])
    check7.click()
    ...
    check8 = func = random.choice([check8_0, check8_1, check8_2, check8_3])
    check8.click()
    ...
    check9 = func = random.choice([check9_0, check9_1])
    check9.click()
